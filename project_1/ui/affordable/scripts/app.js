...
angular
    ...
    .config(function ($routeProvider, $stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        $routeProvider
            ...
            .when('/quote_data', {
                templateUrl: 'affordable/views/quote_data.html',
                controller: 'QuoteDataCtrl',
                controllerAs: 'main',
            })
            .when('/quote_data_no_premium', {
                templateUrl: 'affordable/views/quote_data_no_premium.html',
                controller: 'QuoteDataNoPremiumCtrl',
                controllerAs: 'main',
            })
            .when('/personal', {
                templateUrl: 'affordable/views/personal_info.html',
                controller: 'PersonalCtrl',
                controllerAs: 'main'
            })
            .when('/call_to_apply', {
                templateUrl: 'affordable/views/call_to_apply.html',
