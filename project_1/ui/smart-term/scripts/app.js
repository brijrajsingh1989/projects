...
angular
    ...
    .config(function ($routeProvider, $stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        $routeProvider
            ...
            .when('/quote_data', {
                templateUrl: 'smart-term/views/quote_data.html',
                controller: 'QuoteDataCtrl',
                controllerAs: 'main',
            })
            .when('/quote_data_no_premium', {
                templateUrl: 'smart-term/views/quote_data_no_premium.html',
                controller: 'QuoteDataNoPremiumCtrl',
                controllerAs: 'main',
            })
            .when('/personal', {
                templateUrl: 'smart-term/views/personal_info.html',
                controller: 'PersonalCtrl',
                controllerAs: 'main'
            })
            .when('/call_to_apply', {
                templateUrl: 'smart-term/views/call_to_apply.html',
